...
const Footer = () => {
  return (
    ...
    <div className="flex flex-col md:flex-row justify-between w-full gap-10 border-b border-gray-500/30 pb-6">
        <div className="md:max-w-96">
            ...
            <p className="mt-6 text-sm">
               Experince the power of AI with MoonAI. <br />Create, enhance, and optimize your content with our suite of premium AI tools. Join us and transform your content creation process today!
            </p>
        </div>
    ...
    <p className="pt-4 text-center text-xs md:text-sm pb-5">
        Copyright 2025 © MoonAI. All rights reserved. </p>
</footer>
  )
}

  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
      ...
      <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
        ...
        <p className='text-sm text-gray-500 font-light mt-1'>Supports PDF</p>
      ...
      <div className='w-full max-w-lg p-4 bg-white rounded-lg flex flex-col border border-gray-200 min-h-96 max-h-[600px]'>
        ...
        { !content ? (<div className='flex flex-1 justify-center items-center'>
            <div className='text-sm flex flex-col items-center gap-5 text-gray-500'>
                ...
                <p>Upload a PDF to see the analysis result </p>
            </div>
        </div>
        ) :
        (
          <div className='overflow-y-scroll h-full p-2 text-sm whitespace-pre-wrap text-gray-700' >
